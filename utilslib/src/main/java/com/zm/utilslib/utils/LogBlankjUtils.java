 ...
 * </pre>
 */
public final class LogBlankjUtils {
    ...
    public static class Config {
        ...
        public Config setLogSwitch(final boolean logSwitch) {
            LogBlankjUtils.sLogSwitch = logSwitch;
            return this;
        }

        public Config setConsoleSwitch(final boolean consoleSwitch) {
            LogBlankjUtils.sLog2ConsoleSwitch = consoleSwitch;
            return this;
        }

        public Config setGlobalTag(final String tag) {
            if (isSpace(tag)) {
                LogBlankjUtils.sGlobalTag = "";
                sTagIsSpace = true;
            } else {
                LogBlankjUtils.sGlobalTag = tag;
                sTagIsSpace = false;
            }
            return this;
        }
        ...
        public Config setLogHeadSwitch(final boolean logHeadSwitch) {
            LogBlankjUtils.sLogHeadSwitch = logHeadSwitch;
            return this;
        }

        public Config setLog2FileSwitch(final boolean log2FileSwitch) {
            LogBlankjUtils.sLog2FileSwitch = log2FileSwitch;
            return this;
        }

        public Config setDir(final String dir) {
            if (isSpace(dir)) {
                LogBlankjUtils.dir = null;
            } else {
                LogBlankjUtils.dir = dir.endsWith(FILE_SEP) ? dir : dir + FILE_SEP;
            }
            return this;
        }

        public Config setDir(final File dir) {
            LogBlankjUtils.dir = dir == null ? null : dir.getAbsolutePath() + FILE_SEP;
            return this;
        }

        public Config setBorderSwitch(final boolean borderSwitch) {
            LogBlankjUtils.sLogBorderSwitch = borderSwitch;
            return this;
        }

        public Config setConsoleFilter(@TYPE final int consoleFilter) {
            LogBlankjUtils.sConsoleFilter = consoleFilter;
            return this;
        }

        public Config setFileFilter(@TYPE final int fileFilter) {
            LogBlankjUtils.sFileFilter = fileFilter;
            return this;
        }
